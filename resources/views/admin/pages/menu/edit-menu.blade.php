...
@section('content')
    <div class="page-inner">
        <div class="row">
            <div class="col-md-12">
                <form action="{{ route('admin.menu.update', ['menuId' => $menu->id])}}" method="post">
                    @csrf
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title">Sửa Menu: {{ $menu->name}}</div>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-select form-control rounded-0" name="parent">
                                            ...
                                            @foreach ($menus as $menu_item)
                                                <option value="{{ $menu_item->id }}" {{ old('parent', $menu->parent) == $menu_item->id ? 'selected' : ''}}>{{$menu_item->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="col-12 col-md-5">
                                    <div class="form-group">
                                        ...
                                        <select class="form-select form-control rounded-0" name="position">
                                            <option value="main" {{ old('position', $menu->position) == 'main' ? 'selected' : ''}}>Menu chính</option>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <label class="text-dark fw-bold" for="name_menu">Tên menu <span
                                                class="text-danger">(*)</span></label>
                                        <input type="text" class="form-control form-control rounded-0" id="name_menu"
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control rounded-0" id="alias_menu"
                                            name="alias" value="{{ old('alias', $menu->alias)}}"/>
                                        @error('alias')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control form-control rounded-0" id="order_menu"
                                            name="order" value="{{ old('order', $menu->order)}}"/>
                                        @error('order')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-sm-8 d-flex align-items-center">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="1" id="status"
                                            name="status" {{  old('status', $menu->status) ? 'checked' : '' }}/>
