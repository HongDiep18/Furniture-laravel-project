...
@section('content')
    <div class="page-inner">
        <div class="row">
            <div class="col-md-12">
                <form action="{{ route('admin.category.product.store')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="card">
                            ...
                            <div class="row">
                                <div class="col-12 col-md-7">
                                    <div class="form-group">
                                        ...
                                        <select class="form-select form-control rounded-0" id="formGroupDefaultSelect"
                                            name="parent">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control rounded-0"
                                            id="title_seo_category" name="title_seo" />
                                        @error('title_seo')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <button class="btn btn-outline-danger rounded-0" type="button" id="deleteImage"
                                            disabled>
